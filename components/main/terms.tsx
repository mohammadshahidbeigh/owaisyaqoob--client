...
const Terms: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <h2 className="text-2xl font-bold mt-4">Class Conduct</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-4">Membership</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-4">Liability</h2>
      <p>

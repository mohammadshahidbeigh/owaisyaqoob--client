...
const ReturnPolicy: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <h2 className="text-2xl font-bold mt-4">Membership Fees</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-4">Class Bookings</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-4">Merchandise</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-4">Refunds</h2>
      <p>

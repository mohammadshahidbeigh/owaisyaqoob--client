...
const ReturnPolicy: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <h2 className="text-base md:text-xl font-bold mt-4">Membership Fees</h2>
      <p>
      ...
      <h2 className="text-base md:text-xl font-bold mt-4">Class Bookings</h2>
      <p>
      ...
      <h2 className="text-base md:text-xl font-bold mt-4">Refund Timeframe</h2>
      <p>
        Once your refund request is approved, we will initiate the refund to
        your original method of payment. You will receive the credit within 5-7
        working days, depending on your bank&apos;s processing time.
      </p>

...
const HeroContent = () => {
  return (
    <motion.div
      initial="hidden"
      animate="visible"
      className="relative flex flex-col md:flex-row items-center justify-center px-6 mt-24 md:mt-12 w-full z-[20]"
    >
      {/* Main Content */}
      ...
      >
        <Image src="/hero.png" alt="work icons" height={650} width={650} />
      </motion.div>
    </motion.div>
  );
};
